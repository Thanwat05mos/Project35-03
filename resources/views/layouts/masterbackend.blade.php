...
<head>
    ...
    <title>Nongnit Grocary</title>
    <meta name="description" content="Nongnit Grocary">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ route('p.index') }}"><i class="menu-icon fa fa-cart-plus"></i>สินค้า</a>
                    </li>
                    <li>
                        <a href="{{route('t.index')}}"><i class="menu-icon fa fa-server"></i>ประเภทสินค้า</a>
                    </li>
                    <li>
                        <a href="{{ route('u.index') }}"><i class="menu-icon fa fa-user"></i>ผู้ใช้</a>
                    </li>
            ...
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ route('dashboard') }}"><img
                            src="{{ asset('backend/images/logo1.png') }}" alt="Logo"></a>
